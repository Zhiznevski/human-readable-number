...
return arr[Math.floor(number/100)] + ' hundred and ' + arr[number%100]
if (number>100 && number<1000 && (number%100>=10) && (number%100<20))
return arr[Math.floor(number/100)] + ' hundred and ' + arr[Math.floor(number%100)]
if (number>100 && number<1000 && (number%100>=20) &&(number%10===0)) 
    return arr[Math.floor(number/100)] + ' hundred and ' + arr2[((number%100)/10)] 
if (number>100 && number<1000 && (number%100>=20) && (number%10>0))
return arr[Math.floor(number/100)] + ' hundred and ' + arr2[Math.floor(number%100/10)] + ' ' + arr[number%10]
}
